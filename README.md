...
4. [pytorch_chapter04_nn.ipynb](https://github.com/GaoYang-Thu/learn-pytorch/blob/master/pytorch_chapter04_nn.ipynb) 详细介绍了 nn.Module 工具箱提供的标准层，手把手教你建立最简单的神经网络，然后教你把简单网络堆叠成 sequential 的方法。最后实现了残差神经网络 ResNet。
